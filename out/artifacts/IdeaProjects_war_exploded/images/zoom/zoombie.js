...
(function ($) {
	...
	$.fn.zoombieidk = function (options) {
		return this.each(function () {
			var
			...
			img.onload = function () {
				...
				function start(e) {
					//∑≈¥Û
                    if (document.getElementById(document.getElementById("getstartsign").value + "ss")!=null){
                        document.getElementById(document.getElementById("getstartsign").value + "ss").style.display = "none";
                    }
                    if (document.getElementById(document.getElementById("getendsign").value + "es")!=null){
                        document.getElementById(document.getElementById("getendsign").value + "es").style.display = "none";
                    }
					zoombie.init();
					zoombie.move(e);
